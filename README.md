...
## ⚙️ Fonctionnalités
* 📂 Ouverture d'un fichier Comic Book (formats acceptés : *.cbr, *.cbz, *.rar, *.zip) contenant des images (formats acceptés : *.bmp, *.gif, *.jpeg, *.jpg, *.png)
...
* 🔖 Marque-page
* 💡 Affichage d'une documentation sur le comic
* 📑 Naviguation à travers le comic depuis une table des matières
