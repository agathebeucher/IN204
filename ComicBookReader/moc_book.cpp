...
QT_MOC_LITERAL(1, 5, 11), // "pageChanged"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 14), // "numPageChanged"
QT_MOC_LITERAL(4, 33, 10), // "infoMsgBox"
QT_MOC_LITERAL(5, 44, 3) // "msg"

    },
    "Book\0pageChanged\0\0numPageChanged\0"
    "infoMsgBox\0msg"
};
...
void Book::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Book::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Book::pageChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Book::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Book::infoMsgBox)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Book::pageChanged(bool _t1)
{
...
// SIGNAL 1
void Book::infoMsgBox(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
